#PROBAR EN LA TESTNET
#https://ethereum.stackexchange.com/questions/95179/cant-provide-initial-liquidity-on-pancakeswap-exchange-using-testnet
#https://www.reddit.com/r/pancakeswap/comments/muog5m/pancakeswap_for_bsc_testnet/

#https://docs.pancakeswap.finance/v/espanol/devs/smartcontracts/prediction-v2


#CREADOR DEL BOT: https://github.com/rvrsh3ll/Carnac
...
minbet = float(input("Enter BNB minimum bet value: ")) # 0.0042

basal_multiplier = float(input("Enter bet multiplier value: "))

#balance = float(input("Enter BNB current balance value: "))
